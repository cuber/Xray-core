...
type StrategyWeightedLeastPingConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Relative selection weights. Higher values receive more connections.
	Weights []*StrategyWeight `protobuf:"bytes,1,rep,name=weights,proto3" json:"weights,omitempty"`
	// Hard upper bound for average RTT. Zero disables the bound.
	MaxRTT int64 `protobuf:"varint,2,opt,name=maxRTT,proto3" json:"maxRTT,omitempty"`
	// Include nodes whose average RTT is within this distance of the best node.
	// Zero disables the relative RTT window.
	RttTolerance int64 `protobuf:"varint,3,opt,name=rttTolerance,proto3" json:"rttTolerance,omitempty"`
	// Acceptable health-check failure rate. Zero disables failure-rate filtering.
	Tolerance float32 `protobuf:"fixed32,4,opt,name=tolerance,proto3" json:"tolerance,omitempty"`
	// Minimum number of health-check samples required before a node is eligible.
	MinSamples    int32 `protobuf:"varint,5,opt,name=minSamples,proto3" json:"minSamples,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StrategyWeightedLeastPingConfig) Reset() {
	*x = StrategyWeightedLeastPingConfig{}
	mi := &file_app_router_config_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StrategyWeightedLeastPingConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StrategyWeightedLeastPingConfig) ProtoMessage() {}

func (x *StrategyWeightedLeastPingConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_config_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StrategyWeightedLeastPingConfig.ProtoReflect.Descriptor instead.
func (*StrategyWeightedLeastPingConfig) Descriptor() ([]byte, []int) {
	return file_app_router_config_proto_rawDescGZIP(), []int{5}
}

func (x *StrategyWeightedLeastPingConfig) GetWeights() []*StrategyWeight {
	if x != nil {
		return x.Weights
	}
	return nil
...
func (x *StrategyWeightedLeastPingConfig) GetMaxRTT() int64 {
	if x != nil {
		return x.MaxRTT
	}
	return 0
...
func (x *StrategyWeightedLeastPingConfig) GetRttTolerance() int64 {
	if x != nil {
		return x.RttTolerance
	}
	return 0
}

func (x *StrategyWeightedLeastPingConfig) GetTolerance() float32 {
	if x != nil {
		return x.Tolerance
	}
	return 0
...
func (x *StrategyWeightedLeastPingConfig) GetMinSamples() int32 {
	if x != nil {
		return x.MinSamples
	}
	return 0
...
const file_app_router_config_proto_rawDesc = "" +
	...
	"\ttolerance\x18\x06 \x01(\x02R\ttolerance\"\xd6\x01\n" +
	"\x1fStrategyWeightedLeastPingConfig\x129\n" +
	"\aweights\x18\x01 \x03(\v2\x1f.xray.app.router.StrategyWeightR\aweights\x12\x16\n" +
	"\x06maxRTT\x18\x02 \x01(\x03R\x06maxRTT\x12\"\n" +
	"\frttTolerance\x18\x03 \x01(\x03R\frttTolerance\x12\x1c\n" +
	"\ttolerance\x18\x04 \x01(\x02R\ttolerance\x12\x1e\n" +
	"\n" +
	"minSamples\x18\x05 \x01(\x05R\n" +
	"minSamples\"\x96\x02\n" +
	"\x06Config\x12O\n" +
...
var file_app_router_config_proto_goTypes = []any{
	...
	(*StrategyWeightedLeastPingConfig)(nil), // 6: xray.app.router.StrategyWeightedLeastPingConfig
...
var file_app_router_config_proto_depIdxs = []int32{
	...
	4,  // 14: xray.app.router.StrategyWeightedLeastPingConfig.weights:type_name -> xray.app.router.StrategyWeight
	0,  // 15: xray.app.router.Config.domain_strategy:type_name -> xray.app.router.Config.DomainStrategy
	1,  // 16: xray.app.router.Config.rule:type_name -> xray.app.router.RoutingRule
	3,  // 17: xray.app.router.Config.balancing_rule:type_name -> xray.app.router.BalancingRule
