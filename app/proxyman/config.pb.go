...
type ReceiverConfig struct {
	...
	// Explicit IP listeners sharing one inbound. Mutually exclusive with listen.
	ListenAddresses []*net.IPOrDomain `protobuf:"bytes,7,rep,name=listen_addresses,json=listenAddresses,proto3" json:"listen_addresses,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ReceiverConfig) GetListenAddresses() []*net.IPOrDomain {
	if x != nil {
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\n" +
	"route_only\x18\x05 \x01(\bR\trouteOnly\"\xad\x03\n" +
	...
	"\x11sniffing_settings\x18\x06 \x01(\v2!.xray.app.proxyman.SniffingConfigR\x10sniffingSettings\x12F\n" +
	"\x10listen_addresses\x18\a \x03(\v2\x1b.xray.common.net.IPOrDomainR\x0flistenAddressesJ\x04\b\x05\x10\x06\"\xc0\x01\n" +
...
var file_app_proxyman_config_proto_depIdxs = []int32{
	...
	10, // 6: xray.app.proxyman.ReceiverConfig.listen_addresses:type_name -> xray.common.net.IPOrDomain
