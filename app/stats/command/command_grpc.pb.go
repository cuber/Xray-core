...
const (
	...
	StatsService_GetDomainTrafficBuckets_FullMethodName = "/xray.app.stats.command.StatsService/GetDomainTrafficBuckets"
)
...
type StatsServiceClient interface {
	...
	GetDomainTrafficBuckets(ctx context.Context, in *GetDomainTrafficBucketsRequest, opts ...grpc.CallOption) (*GetDomainTrafficBucketsResponse, error)
}
...
func (c *statsServiceClient) GetDomainTrafficBuckets(ctx context.Context, in *GetDomainTrafficBucketsRequest, opts ...grpc.CallOption) (*GetDomainTrafficBucketsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDomainTrafficBucketsResponse)
	err := c.cc.Invoke(ctx, StatsService_GetDomainTrafficBuckets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatsServiceServer interface {
	...
	GetDomainTrafficBuckets(context.Context, *GetDomainTrafficBucketsRequest) (*GetDomainTrafficBucketsResponse, error)
...
func (UnimplementedStatsServiceServer) GetDomainTrafficBuckets(context.Context, *GetDomainTrafficBucketsRequest) (*GetDomainTrafficBucketsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDomainTrafficBuckets not implemented")
}
...
func _StatsService_GetDomainTrafficBuckets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDomainTrafficBucketsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsServiceServer).GetDomainTrafficBuckets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsService_GetDomainTrafficBuckets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsServiceServer).GetDomainTrafficBuckets(ctx, req.(*GetDomainTrafficBucketsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StatsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDomainTrafficBuckets",
			Handler:    _StatsService_GetDomainTrafficBuckets_Handler,
		},
	},
